...
export default function Nav () {
 ...
 return (<div className=" sticky top-0 bg-gray-800">
    <nav class="relative container text-white  mx-auto p-6">
...
<div class={ mbtn ? "flex flex-col space-y-10  text-black  text-xl rounded-xl absolute inset-x-5 top-[150px] mt-25 bg-white text-center     " : "Menu mt-7 text-xl  space-x-12 mr-10  hidden md:flex"}>
...
<div class =" pt-5 absolute right-12 md:hidden" onClick={handleMenu}>{!mbtn ? <BiMenu size={30}/> : <BiX size={35}/> }</div>
</div>
